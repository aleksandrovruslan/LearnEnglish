...
public class WordsCollectionDAO {
    ...
    public int isAddWordsCollection(WordsCollection collection) throws SQLException {
        int id = 0;
    ...
    public boolean isUpdateWordsCollection(WordsCollection collection) throws SQLException {
    ...
    public boolean isDeleteWordsCollection(int id) throws SQLException {
